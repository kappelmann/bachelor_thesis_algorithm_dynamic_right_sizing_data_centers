...
The correctness of Algorithm~\ref{alg:approx_y_offline_linear} directly follows from Theorem~\ref{thm:approx_y} and the correctness of the shortest path calculation for directed acyclic graphs (for a proof see~\parencite[Section~24.2]{intro-algo}).\unsure{always cite this?}
