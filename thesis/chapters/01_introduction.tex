...
The costs incurred by a single machine are described by the sum of the machine's \emph{operating costs}, specified by \makebox{$f:[0,1]\rightarrow \mathbb{R}$}, as well as its \emph{(power state) switching costs}, specified by $\beta\in\mathbb{R}_{\ge 0}$. 
