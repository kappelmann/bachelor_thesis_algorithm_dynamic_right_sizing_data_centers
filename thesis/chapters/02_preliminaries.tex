...
\end{align}
We subsequently call a schedule $\mx$ \textit{optimal} if it satisfies~\eqref{eq:mx_schedule_total_costs}. Next, we shall approach the first main goal of our work: the development of an optimal offline algorithm.
