...
\end{figure}
Next, we consider the case where $\mx$ rises to $[l,u)$ and then proceeds to ascend to $[l',u')$. In this case, we set $x_i\coloneqq x_{i+1}\coloneqq\dotsb x_j\coloneqq u$ and $x_{j+1}'\coloneqq u'$. Evidently, as in the previous cases, the operating costs of $\mx'$ between $i$ and $j$ is 2-competitive.
\begin{figure}[H]
\centering
