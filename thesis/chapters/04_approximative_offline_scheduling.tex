...
\begin{align*}
	2\bigl(\opcosts(\mx_{i,j})+\beta d\bigr)-\opcosts(\mx_{i,j}^u)&>2\Bigl(\frac{(\hat{u}-u)\opcosts(\mx_{i,j})-d\opcosts(\mx_{i,j}^u)}{\hat{u}-u-2d}\Bigr)-\opcosts(\mx_{i,j}^u)\\
	&=\frac{2(\hat{u}-u)\opcosts(\mx_{i,j})-2d\opcosts(\mx_{i,j}^u)-(\hat{u}-u-2d)\opcosts(\mx_{i,j}^u)}{\hat{u}-u-2d}
\end{align*}
Thus, it suffices to show that
\begin{align*}
	&&\frac{2(\hat{u}-u)\opcosts(\mx_{i,j})-2d\opcosts(\mx_{i,j}^u)-(\hat{u}-u-2d)\opcosts(\mx_{i,j}^u)}{\hat{u}-u-2d}
&\ge 0\\
	&\stackrel{\hat{u}-u-2d>0}{\iff}&2(\hat{u}-u)\opcosts(\mx_{i,j})-2d\opcosts(\mx_{i,j}^u)-(\hat{u}-u-2d)\opcosts(\mx_{i,j}^u)&\ge 0
\end{align*}
