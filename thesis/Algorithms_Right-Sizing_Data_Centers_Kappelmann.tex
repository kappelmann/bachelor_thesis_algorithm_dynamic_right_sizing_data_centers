\documentclass[hidelinks,footsepline=true]{article}
...
\end{algorithm}
The correctness of Algorithm~\ref{alg_opt_offline_pseudo_poly} directly follows from the correctness of the shortest path calculation for directed acyclic graphs (for a proof see~\cite{intro_algo}) and from Theorem~\ref{thm_opt_sched_short_path_pseudo_poly}.
