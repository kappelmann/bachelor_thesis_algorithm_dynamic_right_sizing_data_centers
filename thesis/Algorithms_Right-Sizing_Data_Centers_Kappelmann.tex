...
\end{lem}
\begin{proof}
It is easy to check\unsure{is that ok?} that $\Psi\circ\Phi=id_{\bm{\mathcal{\mx}}}$ and $\Phi\circ\Psi=id_{\bm{\mathcal{P}}}$. Thus, $\Phi$ is indeed bijective with inverse map $\Psi$. Next, let $\mx=(x_1,\ldots,x_T)$ be a schedule for $\inp$. We have
\begin{equation*}
