...
Using above definitions, we can define the input of our model by $\mathcal{I}\coloneqq(m,T,\Lambda,\beta,f)$ with $\Lambda=(\lambda_1,\ldots,\lambda_T)$.
...
\begin{itemize}
	...
	\item $\lambda_{t,i}$\ldots assigned arrival rate at time $t$ for server $i$
	...
	\item $\mx\coloneqq(x_0,\ldots,x_T)$\ldots sequence of active servers
