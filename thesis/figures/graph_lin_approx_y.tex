...
\begin{tikzpicture}[->,>=stealth',auto,node distance=2.2cm,thick,node/.style={minimum size=1.7cm,circle,draw}]
  ...
  \path[every node/.style={font=\sffamily\small}]
	...
	edge node[label={[xshift=0.8cm, yshift=-0.9cm]$\costs\bigl(0,\floor{y^b},\lambda_1\bigr)$}] {} (5)
	edge node[above right=-0.13cm] {$\costs\bigl(0,\floor{y^0},\lambda_1\bigr)$} (3)
    ...
    (15) edge node[label={[xshift=0cm, yshift=-0.26cm]$\opcosts\bigl(\floor{y^0},\lambda_3\bigr)$}] {} ($(15)!.4!(19)$)
    (16) edge node[label={[xshift=0cm, yshift=-0.26cm]$\opcosts(0,\lambda_3)$}] {} ($(16)!.4!(20)$)
    (17) edge node[label={[xshift=0cm, yshift=-0.26cm]$\opcosts\bigl(\floor{y^b},\lambda_3\bigr)$}] {} ($(17)!.4!(21)$)

    ($(14)!.6!(18)$) edge[red] node[black,above] {$\opcosts(m,\lambda_T)$} (18)
    ($(15)!.6!(19)$) edge node[above] {$\opcosts\bigl(\floor{y^0},\lambda_T\bigr)$} (19)
    ($(16)!.6!(20)$) edge node[above] {$\opcosts(0,\lambda_T)$} (20)
    ($(17)!.6!(21)$) edge node[above] {$\opcosts\bigl(\floor{y^b},\lambda_T\bigr)$} (21)
