...
\usepackage{tikz}
\begin{document}
\begin{tikzpicture}[->,>=stealth',auto,node distance=2.2cm,thick,node/.style={minimum size=1.7cm,circle,draw}]
  \node[node] (1) {0,0};
  \node[node] (4) [below right=4cm of 1] {0,1$\downarrow$};
  \node[node] (3) [above =0.5cm of 4] {$\floor{y^0}$,1$\downarrow$};
  \node[node] (2) [above right=4cm of 1] {m,1$\downarrow$};
  \node[node] (5) [below =0.5cm of 2] {$\floor{y^b}$,1$\downarrow$};
  \node[node] (7) [right =of 3] {$\floor{y^0}$,1$\uparrow$};
  \node[node] (6) [right =of 2] {m,1$\uparrow$};
  \node[node] (8) [right =of 4] {0,1$\uparrow$};
  \node[node] (9) [right =of 5] {$\floor{y^b}$,1$\uparrow$};
  \node[node] (11) [right =of 7] {$\floor{y^0}$,2$\downarrow$};
  \node[node] (10) [right =of 6] {m,2$\downarrow$};
  \node[node] (12) [right =of 8] {0,2$\downarrow$};
  \node[node] (13) [right =of 9] {$\floor{y^b}$,2$\downarrow$};
  \node[node] (15) [right =of 11] {$\floor{y^0}$,2$\uparrow$};
  \node[node] (14) [right =of 10] {m,2$\uparrow$};
  \node[node] (16) [right =of 12] {0,2$\uparrow$};
  \node[node] (17) [right =of 13] {$\floor{y^b}$,2$\uparrow$};
  \node[node] (19) [right =5cm of 15] {$\floor{y^0}$,T$\downarrow$};
  \node[node] (18) [right =5cm of 14] {m,T$\downarrow$};
  \node[node] (20) [right =5cm of 16] {0,T$\downarrow$};
  \node[node] (21) [right =5cm of 17] {$\floor{y^b}$,T$\downarrow$};
  ...
  \path[every node/.style={font=\sffamily\small}]
	...
	edge node[label={[xshift=0.8cm, yshift=-1cm]$\costs\bigl(0,\floor{y^b},\lambda_1\bigr)$}] {} (5)
	edge node[above right=-0.28cm] {$\costs\bigl(0,\floor{y^0},\lambda_1\bigr)$} (3)
    ...
    (9) edge[red] node[black,right] {$\beta\bigl(m-\floor{y^b}\bigr)$} (6)
    (8) edge[red] node[black,right] {$\beta$} (7)

    (6) edge[red] node[black,above] {$\opcosts(m,\lambda_2)$} (10)
    (7) edge node[above] {$\opcosts\bigl(\floor{y^0},\lambda_2\bigr)$} (11)
    (8) edge node[above] {$\opcosts(0,\lambda_2)$} (12)
    (9) edge node[above] {$\opcosts\bigl(\floor{y^b},\lambda_2\bigr)$} (13)
    ...
    (17) edge[red] node[black,right] {$\beta\bigl(m-\floor{y^b}\bigr)$} (14)
    (16) edge[red] node[black,right] {$\beta$} (15)

    (5) edge[red] node[black,right] {$0$} ($(5)!.35!(3)$)
    ($(5)!.65!(3)$) edge[red] node[black,right] {$0$} (3)

    ($(7)!.65!(9)$) edge[red] node[black,right] {$\beta\bigl(\floor{y^b}-\floor{y^{b-1}}\bigr)$} (9)
    (7) edge[red] node[black,right] {$\beta\bigl(\floor{y^1}-\floor{y^{0}}\bigr)$} ($(7)!.35!(9)$)
 
    (13) edge[red] node[black,right] {$0$} ($(13)!.35!(11)$)
    ($(13)!.65!(11)$) edge[red] node[black,right] {$0$} (11)

    ($(15)!.65!(17)$) edge[red] node[black,right] {$\beta\bigl(\floor{y^b}-\floor{y^{b-1}}\bigr)$} (17)
    (15) edge[red] node[black,right] {$\beta\bigl(\floor{y^1}-\floor{y^{0}}\bigr)$} ($(15)!.35!(17)$)


    (14) edge[red] node[label={[black,xshift=0cm, yshift=-0.26cm]$\opcosts(m,\lambda_3)$}] {} ($(14)!.4!(18)$)
    (15) edge node[label={[xshift=0.1cm, yshift=-0.26cm]$\opcosts\bigl(\floor{y^0},\lambda_3\bigr)$}] {} ($(15)!.4!(19)$)
    (16) edge node[label={[xshift=0cm, yshift=-0.26cm]$\opcosts(0,\lambda_3)$}] {} ($(16)!.4!(20)$)
    (17) edge node[label={[xshift=0.1cm, yshift=-0.26cm]$\opcosts\bigl(\floor{y^b},\lambda_3\bigr)$}] {} ($(17)!.4!(21)$)

    ($(14)!.6!(18)$) edge[red] node[black,above] {$\opcosts(m,\lambda_T)$} (18)
    ($(15)!.6!(19)$) edge node[label={[xshift=-0.1cm, yshift=-0.26cm]$\opcosts\bigl(\floor{y^0},\lambda_T\bigr)$}] {} (19)
    ($(16)!.6!(20)$) edge node[above] {$\opcosts(0,\lambda_T)$} (20)
    ($(17)!.6!(21)$) edge node[label={[xshift=-0.1cm, yshift=-0.26cm]$\opcosts\bigl(\floor{y^b},\lambda_T\bigr)$}] {} (21)
