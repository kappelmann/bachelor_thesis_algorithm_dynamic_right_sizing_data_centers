...
\begin{tikzpicture}
	...
	\addlegendentry{$x_t$};
	\addplot+[const plot, no marks, thick, color=blue] coordinates {(1,14) (7,14) (7,46) (7.5,46)};
	\addlegendentry{$x_t'$};
	...
	\addplot+[const plot, no marks, thick, dashed, color=black] coordinates {(0,14) (1,14)};
	\addplot+[const plot, no marks, thick, dashed, color=black] coordinates {(7,14) (7.8,14)};
	\addplot+[const plot, no marks, thick, dashed, color=black] coordinates {(0,23) (7.8,23)};
