...
\begin{tikzpicture}[->,>=stealth',auto,node distance=2.2cm,thick,node/.style={minimum size=1.5cm,circle,draw}]
  ...
  \node at ($(23)!.5!(24)$) {\vdots};
  \node at ($(24)!.5!(25)$) {\vdots};
  \node at ($(25)!.5!(26)$) {\vdots};
  ...
  \path[every node/.style={font=\sffamily\small}]
    ...
    (9) edge[red] node[black,right] {$\beta(m-2^b)$} (6)
    ...
    (17) edge[red] node[black,right] {$\beta(m-2^b)$} (14)
    (16) edge[red] node[black,right] {$\beta$} (15)

    (5) edge[red] node[black,right] {$0$} ($(5)!.35!(3)$)
    ($(5)!.65!(3)$) edge[red] node[black,right] {$0$} (3)

    ($(7)!.65!(9)$) edge[red] node[black,right] {$\beta(2^b-2^{b-1})$} (9)
    (7) edge[red] node[black,right] {$\beta(2^1-2^0)$} ($(7)!.35!(9)$)
 
    (13) edge[red] node[black,right] {$0$} ($(13)!.35!(11)$)
    ($(13)!.65!(11)$) edge[red] node[black,right] {$0$} (11)

    ($(15)!.65!(17)$) edge[red] node[black,right] {$\beta(2^b-2^{b-1})$} (17)
    (15) edge[red] node[black,right] {$\beta(2^1-2^0)$} ($(15)!.35!(17)$)
