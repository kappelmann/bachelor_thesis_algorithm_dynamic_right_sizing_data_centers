...
\begin{tikzpicture}[->,>=stealth',auto,node distance=2.2cm,thick,node/.style={minimum size=1.5cm,circle,draw}]
  ...
  \path[every node/.style={font=\sffamily\small}]
    ...
    ($(7)!.65!(9)$) edge[red] node[black,right] {$\beta2^{b-1}$} (9)
    (7) edge[red] node[black,right] {$\beta2^0$} ($(7)!.35!(9)$)
 
    (13) edge[red] node[black,right] {$0$} ($(13)!.35!(11)$)
    ($(13)!.65!(11)$) edge[red] node[black,right] {$0$} (11)

    ($(15)!.65!(17)$) edge[red] node[black,right] {$\beta2^{b-1}$} (17)
    (15) edge[red] node[black,right] {$\beta2^0$} ($(15)!.35!(17)$)
